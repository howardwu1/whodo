...
export default function ProjectPage() {
  ...
  const defaultStories = [
    { title: 'sample story', assignee: username || 'asdf', points: 'unestimated', type: 'feature', dateCreated: 'December 27, 2022', isFinished: false, isDelivered: false, isRejected: false, isAccepted: false, mentor: '', secondaryAssignee: '', secondaryMentor: '', aTeamSupportTime: '', standupComments: '', sessionAndPMComments: '' },
    { title: 'sample story 2', assignee: 'none', points: 5, type: 'bug', dateCreated: 'December 28, 2022', isFinished: false, isDelivered: false, isRejected: false, isAccepted: false, mentor: '', secondaryAssignee: '', secondaryMentor: '', aTeamSupportTime: '', standupComments: '', sessionAndPMComments: '' },
    { title: 'sample story 3', assignee: 'SR', points: 2, type: 'feature', dateCreated: 'December 28, 2022', isFinished: false, isDelivered: false, isRejected: false, isAccepted: false, mentor: '', secondaryAssignee: '', secondaryMentor: '', aTeamSupportTime: '', standupComments: '', sessionAndPMComments: '' },
    { title: 'sample story', assignee: username || 'asdf', points: 3, type: 'feature', dateCreated: 'December 27, 2022', isFinished: false, isDelivered: false, isRejected: false, isAccepted: false, mentor: '', secondaryAssignee: '', secondaryMentor: '', aTeamSupportTime: '', standupComments: '', sessionAndPMComments: '' },
    { title: 'sample story 2', assignee: username || 'asdf', points: 'unestimated', type: 'feature', dateCreated: 'December 28, 2022', isFinished: false, isDelivered: false, isRejected: false, isAccepted: false, mentor: '', secondaryAssignee: '', secondaryMentor: '', aTeamSupportTime: '', standupComments: '', sessionAndPMComments: '' },
    { title: 'sample story 3', assignee: 'SR', points: 2, type: 'feature', dateCreated: 'December 28, 2022', isFinished: false, isDelivered: false, isRejected: false, isAccepted: false, mentor: '', secondaryAssignee: '', secondaryMentor: '', aTeamSupportTime: '', standupComments: '', sessionAndPMComments: '' },
    { title: 'sample story', assignee: username || 'asdf', points: 3, type: 'feature', dateCreated: 'December 27, 2022', isFinished: false, isDelivered: false, isRejected: false, isAccepted: false, mentor: '', secondaryAssignee: '', secondaryMentor: '', aTeamSupportTime: '', standupComments: '', sessionAndPMComments: '' },
    { title: 'sample story 2', assignee: username || 'asdf', points: 5, type: 'feature', dateCreated: 'December 28, 2022', isFinished: false, isDelivered: false, isRejected: false, isAccepted: false, mentor: '', secondaryAssignee: '', secondaryMentor: '', aTeamSupportTime: '', standupComments: '', sessionAndPMComments: '' },
    { title: 'sample story 3', assignee: 'SR', points: 2, type: 'feature', dateCreated: 'December 28, 2022', isFinished: false, isDelivered: false, isRejected: false, isAccepted: false, mentor: '', secondaryAssignee: '', secondaryMentor: '', aTeamSupportTime: '', standupComments: '', sessionAndPMComments: '' },
  ];

  const iceboxDefaultStories = [
    { title: 'forgotten story', assignee: 'SR', points: 2, type: 'feature', dateCreated: 'December 12, 2022', isFinished: false, isDelivered: false, isRejected: false, isAccepted: false, mentor: '', secondaryAssignee: '', secondaryMentor: '', aTeamSupportTime: '', standupComments: '', sessionAndPMComments: '' },
  ];

  const doneDefaultStories = [
    { title: 'finished story', assignee: username || 'asdf', points: 1, type: 'feature', dateCreated: 'November 30, 2022', isFinished: true, isDelivered: true, isRejected: false, isAccepted: true, mentor: '', secondaryAssignee: '', secondaryMentor: '', aTeamSupportTime: '', standupComments: '', sessionAndPMComments: '' },
  ];
